...
const defaultInitialRuns = [
  // KW 38
  {
    ...
    type: 'laufen',
    isErsatz: false,
    tag: 'Coastal Trail Erholung',
    notes: 'Coastal Trail Erholung (5.0 km / 110 Hm / 00:41:24 / 120 bpm)'
  },
  {
    id: 1789766400000,
    kw: 38,
...
if (runsData && runsData.length > 0) {
  ...
  runsData.forEach(r => {
    ...
    if (r.date === '20.09.2026' || r.dayDate === '20.09') {
      r.dist = 5.0;
      r.hm = 110;
      r.duration = '00:41:24';
      r.hr = 120;
...
const appleScheduleData = {
  ...
  38: [
    ...
    { day: 'SON', date: '20.09', tag: 'Coastal Trail Erholung', dist: 5.0, hm: 110, done: true }
  ],
  39: [
      ...
      <div style="margin-top: 0.85rem; padding-top: 0.75rem; border-top: 1px solid rgba(255,255,255,0.08); display: flex; flex-direction: column; gap: 0.55rem;">
        <div style="background: var(--color-tint-cyan-bg); border: 1px solid var(--color-tint-cyan-border); border-radius: var(--border-radius-xl); padding: 0.75rem 1rem; display: flex; flex-direction: column; gap: 0.4rem;">
          ...
          <div style="font-size: 0.82rem; color: var(--color-text-white); line-height: 1.4;">
            ...
            • <strong>Fueling-Setup (2x 500ml):</strong> 1x Flask Malto + 1x Flask Wasser. Wasser an VP 1 (km 10) nachfüllen. (Tipp: 1x Zip-Beutel mit Malto-Portion im Rucksack mitnehmen).
          </div>
        </div>
